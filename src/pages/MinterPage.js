...
import subHeader from "./../assets/image/subheader.jpg";
...
const MinterPage = ({props,colormodesettle}) => {
  ...
  const subHeaderImagePath = `url(${subHeader})`;
  ...
  return (
    <div>
      <GlobalStyles/>
      <section className='jumbotron breadcumb no-bg' style={{backgroundImage: subHeaderImagePath}}>
