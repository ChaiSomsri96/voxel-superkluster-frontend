...
export const defaultState = {
  ...
  myBalance: initEntityState(null) ,
...
const states = (state = defaultState, action) => {
  switch (action.type) {
    ...
    case getType(actions.getBalance.request):
      return { ...state, myBalance: entityLoadingStarted(state.myBalance, action.payload) };
    case getType(actions.getBalance.success):
      return { ...state, myBalance: entityLoadingSucceeded(state.myBalance, action.payload) };
    case getType(actions.getBalance.failure):
      return { ...state, myBalance: entityLoadingFailed(state.myBalance) } ;
